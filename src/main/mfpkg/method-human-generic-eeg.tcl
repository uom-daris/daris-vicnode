#============================================================================#
# Simple method for generic EEG human acquisitions.                          #
#                                                                            #
# Arguments:                                                                 #
...
proc create_method_human_generic_eeg { doc_ns { action 0 } { fillin 0 } } {
    
    set name "DaRIS Generic Human EEG Method"
    set description "DaRIS Method for human subjects with EEG image data acquisitions."
    ...
    set args "${args} \
        ...
        :step < \
            :name \"Generic EEG acquisition for human subject\" \
            :description \"Generic EEG acquisition for human subject\" \
            :study < :type \"Electro Encephalogram\" :metadata < :definition -requirement optional ${doc_ns}:vicnode-study > > >"
