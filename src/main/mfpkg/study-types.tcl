##############################################################################
#                                                                            #
# Create dictionary of Study types.  This populates the framework dictionary #
# daris:pssd.study.types dictionary (this could be changed to something more #
# extensible)                                                                #
#                                                                            #
##############################################################################
proc create_study_types { } {
