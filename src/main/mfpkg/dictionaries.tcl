#============================================================================#
# creates dictionary: ${dict_ns}:pssd.animal.bodypart                        #
#============================================================================#
proc create_dict_pssd_animal_bodypart { dict_ns } {
    set dict ${dict_ns}:pssd.animal.bodypart
...
#============================================================================#
# creates dictionary: ${dict_ns}:pssd.animal.species                         #
#============================================================================#
proc create_dict_pssd_animal_species { dict_ns } {
    set dict ${dict_ns}:pssd.animal.species
